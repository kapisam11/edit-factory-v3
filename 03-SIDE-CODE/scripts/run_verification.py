modules = [
    ('ai_video_factory.knowledge_v3', 'RealKnowledgeBase'),
    ...
    ('ai_video_factory.nle_export_v3', 'export_all_nle_formats'),
    ('ai_video_factory.quality_control_v3', 'run_enhanced_qc'),
]
